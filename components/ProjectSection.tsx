...
export default function ProjectSection() {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gray-200 dark:bg-gray-900 px-6 md:px-12 lg:px-24"
    ...
    <>
      ...
      <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-4">
        <div className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl max-w-3xl mx-auto flex">
          {TechStack.map((tech) => (
            <p key={tech} className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl max-w-3xl mx-auto">
              {tech}
            </p>
          ))}
        </div>
      ...
      <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-4">
        <div className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl max-w-3xl mx-auto flex">
          {relevantLinks.map((link) => (
            <p key={link} className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl max-w-3xl mx-auto">
              {link}
            </p>
          ))}
        </div>
